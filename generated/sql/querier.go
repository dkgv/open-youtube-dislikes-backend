...
type Querier interface {
	...
	FindNVideosMissingDataWithDislikes(ctx context.Context, limit int32) ([]OpenYoutubeDislikesVideo, error)
	FindSentimentByVideoID(ctx context.Context, videoID string) (FindSentimentByVideoIDRow, error)

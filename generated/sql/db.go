...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.findCommentStatusByVideoIDStmt, err = db.PrepareContext(ctx, findCommentStatusByVideoID); err != nil {
		return nil, fmt.Errorf("error preparing query FindCommentStatusByVideoID: %w", err)
	}
	...
	if q.findNVideosMissingDataWithDislikesStmt, err = db.PrepareContext(ctx, findNVideosMissingDataWithDislikes); err != nil {
		return nil, fmt.Errorf("error preparing query FindNVideosMissingDataWithDislikes: %w", err)
	}
	if q.findSentimentByVideoIDStmt, err = db.PrepareContext(ctx, findSentimentByVideoID); err != nil {
		return nil, fmt.Errorf("error preparing query FindSentimentByVideoID: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.findCommentStatusByVideoIDStmt != nil {
		if cerr := q.findCommentStatusByVideoIDStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing findCommentStatusByVideoIDStmt: %w", cerr)
		}
	}
	...
	if q.findNVideosMissingDataWithDislikesStmt != nil {
		if cerr := q.findNVideosMissingDataWithDislikesStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing findNVideosMissingDataWithDislikesStmt: %w", cerr)
		}
	}
	if q.findSentimentByVideoIDStmt != nil {
		if cerr := q.findSentimentByVideoIDStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing findSentimentByVideoIDStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	findCommentStatusByVideoIDStmt         *sql.Stmt
	findDislikeStmt                        *sql.Stmt
	findLikeStmt                           *sql.Stmt
	findNVideosByIDHashStmt                *sql.Stmt
	findNVideosMissingDataStmt             *sql.Stmt
	findNVideosMissingDataWithDislikesStmt *sql.Stmt
	findSentimentByVideoIDStmt             *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		findCommentStatusByVideoIDStmt:         q.findCommentStatusByVideoIDStmt,
		...
		findNVideosMissingDataWithDislikesStmt: q.findNVideosMissingDataWithDislikesStmt,
		findSentimentByVideoIDStmt:             q.findSentimentByVideoIDStmt,
